module github.com/cloudquery/cloudquery/plugins/destination/api
...
require (
	...
	github.com/cloudquery/filetypes/v4 v4.2.21
...
require (
	...
	github.com/cloudquery/plugin-pb-go v1.19.18 // indirect
